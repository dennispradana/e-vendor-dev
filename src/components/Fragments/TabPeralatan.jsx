...
const TabPeralatan = ({ type, formik }) => {
  ...
  const handleDataSelect = (item) => {
    const isDataSelected = formik.values.peralatan.some(
      (selectedItem) => selectedItem.id_prl === item.id_prl
    );

    if (isDataSelected) {
      formik.setFieldValue(
        'peralatan',
        formik.values.peralatan.filter(
          (selectedItem) => selectedItem.id_prl !== item.id_prl
        )
      );
    } else {
      formik.setFieldValue('peralatan', [
        ...formik.values.peralatan,
        {
          id_prl: item.id_prl,
        },
      ]);
