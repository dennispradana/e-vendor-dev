...
const TableLelang = () => {
    ...
    switch (currentStep) {
      ...
      case 4:
        return (
          <FormDokumenLelang
            formik={formik}
            handleModalDok={handleShowDok}
            type="readOnly"
          />
        );
      case 5:
        return <FormPersyaratanLelang data={dataPaket} type="readOnly" />;
      case 6:
        return (
          <FormPesertaLelang data={dataPaket} formik={formik} type="readOnly" />
        );
      default:
        return null;
    }
  ...
  return loading ? (
    ...
    <>
      ...
      {showModaDok && <DokLelang close={handleCloseDok} data={dataPaket} />}
    </>
  );
};
